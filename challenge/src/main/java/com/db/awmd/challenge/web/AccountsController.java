  ...
  public ResponseEntity<Object> transferMoney(@PathVariable String fromAccountId,@PathVariable String toAccountId,@PathVariable BigDecimal amount) {
	...
	try {
    	synchronized(this)  {
    		...
    		BigDecimal newWithdrawnAccountBalance =  this.accountsService.withdraw(fromAccountId,amount);
    		BigDecimal newDepositedAccountBalance =  this.accountsService.deposit(toAccountId,amount);
